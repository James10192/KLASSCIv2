...
class BulletinSectionSummaryTest extends TestCase
{
    public function test_summarize_puts_average_in_moyenne_and_sums_the_rest(): void
    {
        $summary = (new BulletinSectionSummary)->forSection([
            (object) ['matiere_id' => 1, 'moyenne' => 10, 'coefficient' => 2, 'rang' => '8'],
            (object) ['matiere_id' => 2, 'moyenne' => 15, 'coefficient' => 4, 'rang' => '3'],
        ], [
            1 => ['total_heures' => 3],
            2 => ['total_heures' => 1],
        ], null);
    ...
    public function test_single_subject_reuses_the_subject_rank(): void
    {
        $summary = (new BulletinSectionSummary)->forSection([
            (object) ['matiere_id' => 1, 'moyenne' => 14.33, 'coefficient' => 2, 'rang' => '1'],
        ], [], 14.33);

        $this->assertSame(14.33, $summary['moyenne']);
        $this->assertSame(1, $summary['rang']);
    }

    public function test_official_average_wins_over_recomputed(): void
    {
        $summary = (new BulletinSectionSummary)->forSection([
            (object) ['matiere_id' => 1, 'moyenne' => 10, 'coefficient' => 2, 'rang' => '4'],
        ], [], 13.57);

        $this->assertSame(13.57, $summary['moyenne']);
        $this->assertSame(4, $summary['rang']);
    }
