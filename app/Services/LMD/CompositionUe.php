...
class CompositionUe
{
     ...
     *
     * Une chaine vide, un zero ou l'absence valent « commun ». Un parcours qui ne
     * figure pas parmi ceux de l'unite retombe sur « commun » : accepter
     * n'importe quel identifiant creerait une composition rattachee a une
     * maquette qui n'utilise pas cette unite — invisible partout, et impossible
     * a retrouver pour la corriger.
     */
    public function porteeValide(ESBTPUniteEnseignement $ue, mixed $parcoursId): int
    {
        ...
        return $rattache ? $demande : self::COMMUN;
    }
