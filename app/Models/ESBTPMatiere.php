...
class ESBTPMatiere extends Model implements Auditable
{
    ...
    {
        // `parcours_id` expose ici pour la meme raison que sur la relation
        // inverse : sans lui, un lien reserve a une maquette se relit comme
        // commun, en silence.
