...
class ESBTPFraisController extends Controller
{
    ...
    public function configure(Request $request)
    {
        ...
        if ($niveauId && (($systeme === 'LMD' && $parcoursId) || ($systeme !== 'LMD' && $filiereId))) {
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'audience' => 'nullable|in:tous,nouveaux_etablissement,anciens_etablissement',
            'accepts_in_kind' => 'nullable|boolean',
        ...
        try {
            ...
            $fraisCategory = ESBTPFraisCategory::create([
                ...
                'audience' => $request->input('audience', ESBTPFraisCategory::AUDIENCE_TOUS),
                'accepts_in_kind' => $request->boolean('accepts_in_kind'),
                'is_active' => true,
    ...
    public function updateConfiguration(Request $request)
    {
        ...
        try {
            ...
            $scope = $this->fraisScopeResolver->resolveFromConfigurationParams($request->only([
                'systeme',
                'filiere_id',
                'parcours_id',
                'niveau_id',
