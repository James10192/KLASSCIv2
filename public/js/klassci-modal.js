...
class KlassciModal {
    ...
    bindEvents() {
        ...
        const closeButtons = this.newModal.querySelectorAll(
    ...
    show() {
        ...
        if (this.options.focus) {
            setTimeout(() => {
                const firstInput = this.newModal.querySelector(
    ...
    handleFormSubmit(form) {
        ...
        const url =
            form.action ||
            form.dataset.action ||
            "/esbtp/comptabilite/fournisseurs/ajax";
        ...
        fetch(url, {
            ...
            .then((data) => {
                if (data.success) {
                    ...
                    const fournisseurSelect = document.getElementById(
                        "fournisseur_selection"
                    );
                    ...
                    this.showAlert(
                        "success",
                        data.message || "Fournisseur créé avec succès !"
                    );
                } else {
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const triggerButtons = document.querySelectorAll(
        '[data-bs-toggle="modal"][data-bs-target="#modalNouveauFournisseur"]'
    );
