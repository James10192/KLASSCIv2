...
<body class="{{ ($mobileShellEnabled ?? false) && ($mobileProfile ?? null) ? 'has-m-shell m-profile-'.$mobileProfile.' has-stu-bottomnav' : '' }}">
    <div class="nextadmin-wrapper">
        ...
        <div class="sidebar-menu">
                @if(auth()->check())
                    ...
                    @include('layouts.partials.sidebar._etudiants')
                    ...
                    @can('comptabilite.access')
                        ...
                        <div class="menu-accordion">
                            <button class="menu-accordion-btn {{ Request::routeIs('esbtp.comptabilite.*') || Request::routeIs('esbtp.frais.*') || Request::routeIs('esbtp.fee-categories.*') || Request::routeIs('esbtp.payment-categories.*') ? 'active' : '' }}">
                                <div class="menu-icon"><i class="fas fa-coins"></i></div>
                                <div class="menu-text">Comptabilité</div>
                                <div class="menu-arrow"><i class="fas fa-chevron-down"></i></div>
                            </button>
                            <div class="menu-accordion-content {{ Request::routeIs('esbtp.comptabilite.*') || Request::routeIs('esbtp.frais.*') || Request::routeIs('esbtp.fee-categories.*') || Request::routeIs('esbtp.payment-categories.*') ? 'show' : '' }}">
                    ...
                    @can('system.manage')
                        ...
                        <!-- System Settings -->
                        <div class="menu-accordion">
                            <button class="menu-accordion-btn {{ Request::routeIs('esbtp.settings.*') || Request::routeIs('esbtp.logs.*') || Request::routeIs('esbtp.parent-chatbot-onboarding.*') ? 'active' : '' }}">
                                <div class="menu-icon"><i class="fas fa-cogs"></i></div>
                                <div class="menu-text">Paramètres</div>
                                <div class="menu-arrow"><i class="fas fa-chevron-down"></i></div>
                            </button>
                            <div class="menu-accordion-content {{ Request::routeIs('esbtp.settings.*') || Request::routeIs('esbtp.logs.*') || Request::routeIs('esbtp.parent-chatbot-onboarding.*') ? 'show' : '' }}">
                                <a href="{{ route('esbtp.settings.index') }}" class="menu-sublink {{ Request::routeIs('esbtp.settings.*') ? 'active' : '' }}">
                                    <span class="menu-dot"></span>
                                    <span>Configuration</span>
                                </a>
                                @can('parent_chatbot.manage')
                                <a href="{{ route('esbtp.parent-chatbot-onboarding.index') }}" class="menu-sublink {{ Request::routeIs('esbtp.parent-chatbot-onboarding.*') ? 'active' : '' }}">
                                    <span class="menu-dot"></span>
                                    <span>Chatbot parents</span>
                                </a>
                                @endcan
    ...
    @include('layouts.partials.regles-universelles')
