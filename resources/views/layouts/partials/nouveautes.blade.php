...
<style>
    ...
    .nvx-hero { background: linear-gradient(135deg, #0a3d8f 0%, #0453cb 45%, #3b7ddb 100%); color: #fff; padding: 1.25rem 1.4rem 1rem; }
    .nvx-hero-top { display: flex; align-items: flex-start; gap: .85rem; }
    ...
    .nvx-corps { padding: 1.25rem 1.4rem .5rem; min-height: 230px; }
    ...
    .nvx-cadre img { display: block; width: 100%; height: auto; }
    ...
    .nvx-pied { display: flex; align-items: center; gap: .6rem; padding: .85rem 1.4rem 1.1rem; border-top: 1px solid #eef2f7; }
