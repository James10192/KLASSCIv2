            ...
            <form method="POST" action="{{ route('admin.password.update') }}" id="adminPasswordForm">
                ...
                <div style="padding: 1.75rem;">
                    ...
                    <div style="margin-bottom: 1.25rem;">
                        ...
                        <div style="margin-top: 0.5rem; display: flex; gap: 0.25rem;" id="adminPasswordForm_strength">
                            <div style="height: 3px; flex: 1; border-radius: 2px; background: #e2e8f0; transition: background 0.3s;"></div>
                            <div style="height: 3px; flex: 1; border-radius: 2px; background: #e2e8f0; transition: background 0.3s;"></div>
                            <div style="height: 3px; flex: 1; border-radius: 2px; background: #e2e8f0; transition: background 0.3s;"></div>
                            <div style="height: 3px; flex: 1; border-radius: 2px; background: #e2e8f0; transition: background 0.3s;"></div>
                        </div>
                        <div style="font-size: 0.75rem; color: #94a3b8; margin-top: 0.35rem;" id="adminPasswordForm_strength_text">Min. 8 caracteres, majuscule, chiffre, symbole</div>
                    </div>
                    ...
                    <div style="margin-bottom: 0.5rem;">
                        ...
                        <div style="font-size: 0.75rem; color: #ef4444; margin-top: 0.35rem; display: none;" id="adminPasswordForm_mismatch">
