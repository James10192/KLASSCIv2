                ...
                <td style="padding: 16px;">
                    <div style="display: flex; align-items: center;">
                        ...
                        <div>
                            ...
                            @php
                                $classeListe = $analyse['classe'] ?? $analyse['inscription']->classe ?? null;
                                $niveauListe = $classeListe?->niveau;
                            @endphp
                            @if($niveauListe)
                                <div><span class="badge" style="background:#e8f0fe;color:#0453cb;font-size:.65rem;">{{ $niveauListe->etiquetteCycle() }}</span></div>
                            @endif
                        </div>
                    </div>
                </td>
