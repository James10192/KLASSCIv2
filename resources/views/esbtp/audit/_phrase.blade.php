{{-- Une action du journal, dite comme une phrase, precedee de son jour quand il change.
     ...
     Attend $l (App\Domain\Audit\LigneDuJournal) et $afficherJour. Le jour porte sa propre
...
@endif
<a href="{{ route('esbtp.audit.show', $l->id) }}" class="jda-ligne {{ $l->motifs !== [] ? 'is-alerte' : '' }}" data-li-cle="{{ $l->id }}">
