            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-grid gap-2">
                        <a href="{{ route('esbtp.frais.configure') }}" class="btn btn-primary" title="Configurer les frais pour chaque classe (filière + niveau)">
                            <i class="fas fa-cogs me-1"></i>Configuration par Classe
                        </a>
                        <button class="btn btn-info" onclick="showVariantsModal()" title="Voir tous les variants de toutes les catégories">
                            <i class="fas fa-list me-1"></i>Voir tous les Variants
                        </button>
                        <a href="{{ route('esbtp.frais.create') }}" class="btn btn-success" title="Créer une nouvelle catégorie de frais">
                    ...
                    <div class="alert alert-info small">
                        ...
                        <ol class="mb-0 mt-1 ps-3">
                            <li>Créer les catégories de frais</li>
                            <li>Ajouter des variants (optionnel)</li>
                            <li>Configurer par classe</li>
                        </ol>
                    </div>
                </div>
            </div>
