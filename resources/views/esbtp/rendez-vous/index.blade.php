...
<div class="container-fluid">
    ...
    @php
        ...
        $_joursChoisis = array_filter(preg_split('/[,\s]+/', (string) \App\Helpers\SettingsHelper::get($_rdv::JOURS, '1,2,3,4,5')));
    @endphp
