    ...
    <div class="fe-wrap">
        ...
        <form action="{{ route('esbtp.filieres.update', $filiere) }}" method="POST" x-data="feFiliereForm()">
            ...
            <div class="fe-card">
                ...
                {{-- Filière parente — TOUJOURS visible pour permettre une hiérarchie
                     multi-niveaux : une filière (spécialité OU tronc commun secondaire)
                     peut être rattachée à un tronc commun parent. Le champ reste
                     visible même quand is_tronc_commun=true (bug juin 2026 — Marcel). --}}
