...
@section('title', 'Créer un responsable scolarite')

@section('content')
<div class="main-content">
    <div class="dashboard-header mb-xl" style="background-color: var(--primary); color: white; border-radius: var(--radius-medium);">
        <h1 style="color:white;margin:0;">Nouveau responsable scolarite</h1>
        <p style="color:rgba(255,255,255,.8);margin:6px 0 0;">Compte pédagogique sans accès finance ni système.</p>
    </div>

    <form method="POST" action="{{ route('esbtp.responsables-scolarite.store') }}" class="card-moderne" style="padding: var(--space-xl);">
        @csrf
        <div class="row g-3">
            <div class="col-md-6">
