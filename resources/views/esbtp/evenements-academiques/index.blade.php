        ...
        <div class="card-moderne">
            ...
            <div class="card-body-moderne">
                ...
                @endif
                    ...
                    <div class="evenements-liste" id="eva-liste">
                        @forelse($evenements as $evenement)
                        @include('esbtp.evenements-academiques._carte')
                        @empty
                    ...
                    <x-liste-infinie :paginateur="$evenements" cible="#eva-liste" libelle="événements" />
                </div>
            </div>
        </div>
    </div>
