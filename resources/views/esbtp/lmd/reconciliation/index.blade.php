            ...
            <div class="rec-modal-body">
                ...
                <template x-if="modal.done">
                    <div>
                        ...
                        <div class="rec-impact-row"><span>Moyennes recalculées</span><strong x-text="(modal.done.resultats || {}).recalcules || 0"></strong></div>
        ...
        async confirmMerge() {
            ...
            try {
                ...
                if (report && report.committed) {
                    ...
                    if (this.orphelins(report).length || this.conflitsLmd(report).length || this.bulletinsARegenerer(report).length) {
