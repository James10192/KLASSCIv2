@php
    $decisionsData = $jury->decisions->map(function ($d) {
        return [
            ...
            'decision_auto_label' => \App\Models\ESBTPLMDJuryDecision::libelleDecision($d->decision_auto),
            'decision' => $d->decision,
            'decision_label' => \App\Models\ESBTPLMDJuryDecision::libelleDecision($d->decision),
            'mention' => $d->mention,
            'mention_label' => \App\Models\ESBTPLMDJuryDecision::libelleMention($d->mention),
