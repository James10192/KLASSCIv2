...
<div class="container-fluid cpa-shell"
    ...
    @can('academic_sheets.assign')
    <section class="cpa-panel" x-show="tab === 'assignments'">
        <div class="cpa-panel-head">
            <div>
        ...
        <form class="cpa-assignment-form" x-ref="assignmentForm" @submit.prevent="saveAssignment()">
            <div class="cpa-field">
            ...
            <button type="submit" class="cpa-btn cpa-btn--primary" :disabled="assignmentState.saving || !filters.year_id">
        ...
        <div class="cpa-state mt-3" x-show="!assignmentState.loading && !assignmentState.items.length"><i class="fas fa-user-tag"></i>Aucune affectation active pour ces filtres.</div>
    </section>
    @endcan
