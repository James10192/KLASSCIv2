    ...
    <tr>
        ...
        <td class="col-actions">
            <div class="btn-group-moderne">
                <a href="{{ route('esbtp.emploi-temps.preview-pdf', ['emploi_temp' => $emploiTemps->id]) }}" class="btn-moderne" title="Aperçu PDF" target="_blank" style="background:#fff;border:1px solid #e2e8f0;color:#0453cb;">
                ...
                @if(auth()->user()->hasAnyPermission(['admin.access', 'identity.school_manager']) || auth()->user()->can('timetables.edit'))
