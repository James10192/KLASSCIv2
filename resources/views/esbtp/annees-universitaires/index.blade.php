                                ...
                                <tbody>
                                    @foreach($anneesUniversitaires as $anneeUniversitaire)
                                        <tr class="{{ $anneeUniversitaire->is_current ? 'table-success' : '' }}">
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="{{ route('esbtp.annees-universitaires.show', $anneeUniversitaire) }}" class="btn btn-info btn-sm" title="Voir les détails">
                                                    ...
                                                    @endif
                                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal{{ $anneeUniversitaire->id }}" title="Supprimer">
                                                        <i class="fas fa-trash"></i>
                                                    </button>
                                                </div>

                                                <!-- Modal de confirmation de suppression -->
                                                <div class="modal fade" id="deleteModal{{ $anneeUniversitaire->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel{{ $anneeUniversitaire->id }}" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="{{ route('esbtp.annees-universitaires.destroy', $anneeUniversitaire) }}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
