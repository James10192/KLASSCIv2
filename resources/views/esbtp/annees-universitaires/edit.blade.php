            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('esbtp.annees-universitaires.update', $anneesUniversitaire) }}" method="POST">
                        ...
                        <div class="form-group">
                            <label for="start_date" class="form-label">Date de rentrée
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="3">{{ old('description', $anneesUniversitaire->description) }}</textarea>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" value="1" {{ old('is_active', $anneesUniversitaire->is_active) ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="is_current" name="is_current" value="1" {{ old('is_current', optional($anneesUniversitaire)->is_current) ? 'checked' : '' }}>
                        ...
                        <div class="form-group text-center">
                            ...
                            <a href="{{ route('esbtp.annees-universitaires.show', $anneesUniversitaire) }}" class="btn btn-secondary">
