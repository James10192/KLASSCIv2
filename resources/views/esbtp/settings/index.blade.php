        ...
        <form action="{{ route('esbtp.settings.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="settings-section">
                ...
                <div class="bc-grid bc-grid-2">
                    @php $tcToggles = [
                        ['name' => 'tronc_commun_enabled', 'key' => 'tronc_commun_enabled', 'label' => 'Activer le tronc commun', 'desc' => 'Permet aux filieres marquees "tronc commun" de proposer une specialisation en cours d\'annee', 'icon' => 'fa-toggle-on', 'color' => '', 'default' => '0'],
                        ['name' => 'tronc_commun_mga_include_s1', 'key' => 'tronc_commun_mga_include_s1', 'label' => 'Reporter les notes S1 dans la MGA', 'desc' => 'Inclure les notes du tronc commun (S1) dans le calcul de la Moyenne Generale Annuelle', 'icon' => 'fa-clipboard-check', 'color' => '', 'default' => '1'],
                        ['name' => 'tronc_commun_report_paiements', 'key' => 'tronc_commun_report_paiements', 'label' => 'Reporter les paiements', 'desc' => 'Reporter automatiquement les paiements du tronc commun sur la specialisation', 'icon' => 'fa-money-bill-transfer', 'color' => '', 'default' => '1'],
                        ['name' => 'tronc_commun_report_notes', 'key' => 'tronc_commun_report_notes', 'label' => 'Reporter les notes', 'desc' => 'Conserver les notes du S1 (tronc commun) accessibles depuis la specialisation', 'icon' => 'fa-file-lines', 'color' => '', 'default' => '1'],
                        ['name' => 'tronc_commun_bulletin_show_origin', 'key' => 'tronc_commun_bulletin_show_origin', 'label' => 'Afficher la classe d\'origine', 'desc' => 'Mentionner la classe de tronc commun (S1) sur le bulletin de la specialisation (S2)', 'icon' => 'fa-id-card', 'color' => '', 'default' => '1'],
                        ['name' => 'tronc_commun_matieres_communes', 'key' => 'tronc_commun_matieres_communes', 'label' => 'Matieres communes automatiques', 'desc' => 'Detecter les matieres partagees entre TC et specialisation, reporter les notes automatiquement', 'icon' => 'fa-link', 'color' => '', 'default' => '1'],
                        ['name' => 'tronc_commun_planning_semestre_strict', 'key' => 'tronc_commun_planning_semestre_strict', 'label' => 'Planning strict par semestre', 'desc' => 'Restreindre le planning general : matieres TC en S1 uniquement, matieres specialisation en S2 uniquement', 'icon' => 'fa-calendar-check', 'color' => '', 'default' => '0'],
                    ]; @endphp
