    ...
    <div class="se-section">
        <div class="se-section-header">
            ...
            <div class="btn-group" role="group" id="add-parent-group" {{ $etudiant->parents->count() >= 2 ? 'style="display:none;"' : '' }}>
                ...
                <button type="button" class="btn btn-sm btn-outline-primary" id="add-existing-parent" onclick="document.getElementById('searchParentModal').style.display='flex';document.body.classList.add('parent-panel-open');window.scrollTo(0,0);if(window.parent)window.parent.postMessage('parent-search-open','*')" style="border-radius:0 8px 8px 0;">
...
<div id="searchParentModal" class="parent-search-overlay" style="display:none;">
    <div class="parent-search-panel">
        <div class="parent-search-header">
            ...
            <button type="button" class="parent-search-close" onclick="document.getElementById('searchParentModal').style.display='none';document.body.classList.remove('parent-panel-open');if(window.parent)window.parent.postMessage('parent-search-close','*')"
