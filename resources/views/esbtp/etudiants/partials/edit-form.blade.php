...
<div id="searchParentModal" class="parent-search-overlay" style="display:none;">
    <div class="parent-search-panel">
        <div class="parent-search-header">
            ...
            <button type="button" class="parent-search-close" onclick="document.getElementById('searchParentModal').style.display='none';document.body.classList.remove('parent-panel-open')"
