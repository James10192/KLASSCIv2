    ...
    */
    ...
    'permissions' => [
        ...
        'inscriptions.rdv.view' => [
            'label' => 'Voir le planning des rendez-vous d\'inscription',
            'group' => 'Inscriptions',
            'icon' => 'fa-calendar-check',
        ],
        'inscriptions.rdv.manage' => [
            'label' => 'Gérer les créneaux de rendez-vous d\'inscription',
            'group' => 'Inscriptions',
            'icon' => 'fa-calendar-plus',
        ],
        'inscriptions.rdv.configure' => [
            'label' => 'Configurer les rendez-vous d\'inscription',
            'group' => 'Inscriptions',
            'icon' => 'fa-sliders-h',
        ],
        'inscriptions.manage' => [
        ...
        'pieces_dossier.view' => [
            ...
            'description' => 'Lecture seule : quelles pieces l ecole reclame, en combien d exemplaires, a quelles filieres et a quels niveaux.',
            'group' => 'Documents',
            'icon' => 'fa-list-check',
        ],
