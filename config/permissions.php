...
return [
    ...
    */
    ...
    'role_defaults' => [
        ...
        'directeurEtudes' => [
            ...
            'inscriptions.view', 'inscriptions.create', 'inscriptions.edit',
            'inscriptions.validate', 'inscriptions.cancel', 'inscriptions.reject',
            'inscriptions.manage', 'inscriptions.specialisation.manage',
            'cycles.view', 'cycles.edit',
            'classes.view',
            'filieres.view', 'niveaux.view',
            'annees.view',
            'bts_tronc_commun.view', 'bts_tronc_commun.orient',
            'bts_tronc_commun.manage_targets', 'bts_tronc_commun.view_history',
            'matieres.view', 'matieres.create', 'matieres.edit',
            'notes.view', 'notes.create', 'notes.import_excel',
            'evaluations.view', 'evaluations.create', 'evaluations.edit',
            'exams.view',
    ...
    */
    ...
    'role_management' => [
        ...
        'serviceTechnique' => ['superAdmin', 'secretaire', 'comptable', 'caissier', 'coordinateur', 'directeurEtudes', 'enseignant', 'etudiant'],
