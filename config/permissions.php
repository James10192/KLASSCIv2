    ...
    */
    ...
    'roles' => [
        ...
        'responsableScolarite' => [
            'label' => 'Responsable scolarite',
            'description' => 'Valide les documents de scolarite, ouvre les fenetres de notes et pilote le service scolarite. Sans finance ni configuration systeme.',
            'icon' => 'fa-user-check',
            'group' => 'Administration',
            'visible_in_ui' => true,
        ],
        'serviceScolarite' => [
            'label' => 'Service scolarite',
    ...
    */
    ...
    'permissions' => [
        ...
        'responsables_scolarite.view' => [
            'label' => 'Voir les responsables scolarite',
            'group' => 'Personnel',
            'icon' => 'fa-user-check',
        ],
        'responsables_scolarite.create' => [
            'label' => 'Creer un responsable scolarite',
            'group' => 'Personnel',
            'icon' => 'fa-plus',
        ],
        'responsables_scolarite.edit' => [
            'label' => 'Modifier un responsable scolarite',
            'group' => 'Personnel',
            'icon' => 'fa-edit',
        ],
        'responsables_scolarite.delete' => [
            'label' => 'Supprimer un responsable scolarite',
            'group' => 'Personnel',
            'icon' => 'fa-trash',
        ],
        'services_scolarite.view' => [
            'label' => 'Voir le service scolarite',
            'group' => 'Personnel',
            'icon' => 'fa-print',
        ],
        'services_scolarite.create' => [
            'label' => 'Creer un agent du service scolarite',
            'group' => 'Personnel',
            'icon' => 'fa-plus',
        ],
        'services_scolarite.edit' => [
            'label' => 'Modifier un agent du service scolarite',
            'group' => 'Personnel',
            'icon' => 'fa-edit',
        ],
        'services_scolarite.delete' => [
            'label' => 'Supprimer un agent du service scolarite',
            'group' => 'Personnel',
            'icon' => 'fa-trash',
        ],
        'secretaires.view' => [
        ...
        'identity.registrar' => [
            'label' => 'Identite responsable scolarite (routing UI)',
            'group' => 'Identité',
            'icon' => 'fa-user-check',
        ],
