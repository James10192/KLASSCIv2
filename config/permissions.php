...
return [
    ...
    */
    ...
    'permissions' => [
        ...
        'inscriptions.dossier.view' => [
            'label' => 'Voir les pièces du dossier d\'une inscription',
            'group' => 'Inscriptions',
            'icon' => 'fa-folder-open',
        ],
        'inscriptions.dossier.manage' => [
            'label' => 'Constater la remise d\'une pièce du dossier',
            'description' => 'Marquer une pièce fournie, manquante ou sans objet, et déposer le fichier correspondant.',
            'group' => 'Inscriptions',
    ...
    */
    ...
    'role_defaults' => [
        ...
        'secretaire' => [
            ...
            'inscriptions.dossier.view', 'inscriptions.dossier.manage',
